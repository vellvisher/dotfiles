  ...
  (let ((custom-bookmarks
         '((:name  "Important (unread)"
           ...
           (:name  "Inbox - Privacy, Terms & Surveys"
            :query "maildir:/Gmail/Inbox AND (subject:\"privacy policy\" OR subject:\"privacy notice\" OR subject:\"agreement\" OR subject:\"terms of service\" OR subject:\"terms and conditions\" OR subject:\"terms of use\" OR subject:unsubscribe OR subject:newsletter OR subject:survey OR subject:\"feedback request\" OR subject:\"share your feedback\" OR subject:\"tell us what you think\" OR subject:\"we'd love your feedback\" OR subject:\"how did we do\" OR subject:\"rate your experience\" OR subject:\"tell us\" OR subject:\"refer and earn\" OR subject:\"refer a friend\" OR subject:\"referral\")"
            :key   ?p))))
    (setq mu4e-bookmarks
